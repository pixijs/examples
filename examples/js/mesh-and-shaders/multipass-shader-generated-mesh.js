...
const gridTexture = new PIXI.RenderTexture.create(200, 200);
...
const rippleTexture = new PIXI.RenderTexture.create(200, 200);
...
const noiseTexture = new PIXI.RenderTexture.create(200, 200);
...
const waveTexture = new PIXI.RenderTexture.create(200, 200);
...
const combineTexture = new PIXI.RenderTexture.create(200, 200);
