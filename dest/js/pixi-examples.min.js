    ...
    bpc.initNav = function initNav() {
        ...
        $(".main-menu li").on(bpc.clickType, (function onClick() {
            if (!$(this).hasClass("selected")) {
                ...
                const readableSection = section.replace(/-/g, " ").replace(/^\w/g, m => m.toUpperCase());
        ...
        function beforeSubmit(event) {
            ...
            const js = document.getElementById("code").value.replace(/(['"])(\.\/)?examples\//gm, "$1https://pixijs.io/examples/examples/");
            const jsExternal = [ `https://d157l7jdn8e5sf.cloudfront.net/${bpc.pixiVersionString}/pixi-legacy.js` ];
            const tags = [ "PixiJS" ];
