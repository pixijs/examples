...
class BagPart extends PROJ.Container3d {
    ...
    _rChange() {
        ...
        p3d.x = (p.x + 1) * .5 * this.sideWidth;
        p3d.y = (p.y + 1) * .5 * this.sideHeight;
    ...
    get realLink() {
        return new PIXI.Point(
            this.sideWidth * (this.linkPoint.x + 1) * .5,
            this.sideHeight * (this.linkPoint.y + 1) * .5);
    }
    ...
    bind(parent, link = [-1, 0]) {
        ...
        const x = .5 * (link[0] + 1) * parent.sideWidth;
        const y = .5 * (link[1] + 1) * parent.sideHeight;
    ...
    link() {
        ...
        const x = p.sideWidth * (link[0] + 1) * .5;
        const y = p.sideHeight * (link[1] + 1) * .5;
